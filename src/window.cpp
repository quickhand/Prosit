	...
	m_current_wordcount(0)
{
	...
	setWindowIcon(QIcon(":/prosit.png"));
...
void Window::initMenus()
{
	...
	format_menu->addSeparator();
        ...
        QActionGroup* blockstyles = new QActionGroup(this);
        ...
        blockstyles->addAction(m_actions["FormatSetHeading1"]);
        ...
        blockstyles->addAction(m_actions["FormatSetHeading2"]);
        ...
        blockstyles->addAction(m_actions["FormatSetHeading3"]);
        ...
        blockstyles->addAction(m_actions["FormatSetHeading4"]);
        ...
        blockstyles->addAction(m_actions["FormatSetHeading5"]);
        ...
        blockstyles->addAction(m_actions["FormatSetBlockquote"]);
        ...
        blockstyles->addAction(m_actions["FormatSetAttribution"]);
        ...
        blockstyles->addAction(m_actions["FormatSetPreformatted"]);
        ...
        blockstyles->addAction(m_actions["FormatSetDivider1"]);
        ...
        blockstyles->addAction(m_actions["FormatSetDivider2"]);
        ...
        blockstyles->addAction(m_actions["FormatSetDivider3"]);
        ...
        blockstyles->addAction(m_actions["FormatSetDivider4"]);
        ...
        blockstyles->addAction(m_actions["FormatSetDivider5"]);
        ...
        blockstyles->addAction(m_actions["FormatSetNormalParagraph"]);
